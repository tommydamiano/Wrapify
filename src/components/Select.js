  ...
  return (
    <div className= 'main-select-div'>
      ...
      <div className='welcome-div'>
        <FadeIn delay={150} transitionDuration={700}><h1>Welcome, {name}!</h1></FadeIn>
        <Fade right big><img src={profilePic} alt='pro-pic'></img></Fade>
      </div>
      <SpotifyApiContext.Provider value={token}>
        <div className='choice-container'>
          ...
          <Link to='/artists' className='choice-artist' onMouseEnter={() => createBlur(true)} onMouseLeave={() => createBlur(false)}>
            <div>Top Artists</div>
